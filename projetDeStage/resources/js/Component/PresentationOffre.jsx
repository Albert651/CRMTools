...
const PresentationOffre = () => {
  ...
  function OutlineTypesExample() {
    return (
      <>
        <Link to='/GestionOffre'  className="btn btn-outline-primary"  ><i class="bi bi-cart3" >  Presentation des offres</i></Link>{' '}
        <Link to='/GestionDeDevis' className='ms-2 btn btn-outline-primary'><i class="bi bi-cash-coin">  Gestion des devis</i></Link>{' '}
        <Link to='/GererOffre' className='ms-2 btn btn-outline-primary'><i class="bi bi-cart3">  Gestion des offres</i></Link>
      </>
    );
  }
  ...
  return (
    <Container className="presentation-container mt-4" >
        <h2 className="mb-4 bg-secodary">Gestion des devis/offre</h2>
            <OutlineTypesExample />
